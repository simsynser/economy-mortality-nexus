# How old are you compared to most people? - Data package

This data package contains the data that powers the chart ["How old are you compared to most people?"](https://ourworldindata.org/grapher/your-age-compared-to-the-world-median-age?tab=map&time=2022&country=~EGY&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
