...
This data package contains the data that powers the chart ["Median age"](https://ourworldindata.org/grapher/median-age?tab=table&time=2022&overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
